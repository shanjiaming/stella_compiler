...
public interface MxstarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MxstarParser#varSingleDeclare}.
	 * @param ctx the parse tree
	 */
	void enterVarSingleDeclare(MxstarParser.VarSingleDeclareContext ctx);
	/**
	 * Exit a parse tree produced by {@link MxstarParser#varSingleDeclare}.
	 * @param ctx the parse tree
	 */
	void exitVarSingleDeclare(MxstarParser.VarSingleDeclareContext ctx);
	/**
